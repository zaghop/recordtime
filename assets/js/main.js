...
$(function() {
    ...
    if (calendar_selector.length > 0) {
        ...
        calendar_settings.customButtons.calendarFilter = {
            text: filter_by_string.toLowerCase(),
            click: function() {
...
function init_rel_tasks_table(rel_id, rel_type, selector) {
    ...
    var Api = initDataTable(selector, admin_url + 'tasks/init_relation_tasks/' + rel_id + '/' + rel_type, [not_sortable_tasks], [not_sortable_tasks], TasksServerParams, [2, 'ASC']);
