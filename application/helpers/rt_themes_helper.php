...
{
    return base_url('assets/themes/' . get_option('website_default_theme')) . '/';
}
function template_assets_path()
{
    return 'assets/themes/' . get_option('website_default_theme');
}
/**
...
function get_template_part($name, $data = array(), $return = false)
{
    $CI =& get_instance();
    if ($return == true) {
        return $CI->load->view('themes/' . get_option('website_default_theme') . '/' . 'template_parts/' . $name, $data, TRUE);
    }
    $CI->load->view('themes/' . get_option('website_default_theme') . '/' . 'template_parts/' . $name, $data);
}
/**
...
function active_clients_theme()
{
   ...
   $theme = get_option('website_default_theme');
    if ($theme == '') {
