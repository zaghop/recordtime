		...
		<div class="row project-inner-section">
			<div class="col-md-3">
				<div class="arrow left-arrow box-shadow">
					<a href="<?php echo site_url('artists/editproductionrates')?>"><i class="fa fa-arrow-left " aria-hidden="true"></i><b style="color: #fff; font-size: 25px; padding: 18px; border: none;">Return to calculator</b></a>
				</div>
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-3">
				<div class="project-details-container">
					<div class="arrow right-arrow box-shadow">
						<a href="<?php echo site_url('artists/profile')?>"><b style="color: #fff; font-size: 25px; padding: 18px; border: none;">Finish</b><i class="fa fa-arrow-right" aria-hidden="true" style="float: right; margin-top: 10px;"></i></a>
					</div>
				</div>
			</div>
		</div>
